...
<div class="about-com content" id="company_gallery">
	...
	<p>
		私たちは、きのこや山菜、りんごなどの信州ならではの食材を使って、きのこがたっぷり入った炊き込みご飯の素やお惣菜、果物が丸ごと入ったゼリーなどの加工食品を作っています。<br>
...
<section class="content" id="numeric_data">
	...
	<div class="large">
		<p>売上高</p>
		<p class="num"><span>7</span>億<span>3</span>千万円</p>
	...
	<ul class="gr_con">
		...
		<li class="circle">
			<p>育児休暇率</p>
			<div class="one">
				<p class="num"><span>20</span>%</p>
			</div>
		</li>
		<li class="circle">
			<p>新卒・中途の比率</p>
			<div class="two">
				<p class="num"><span>3:7</span></p>
			</div>
		</li>
	</ul>
	<ul class="fl_con">
		...
		<div class="chart">
			...
			<svg width="150" height="150" viewBox="0 0 200 200">
				<?php create_donut_graph(100, 100, 100, 40, [
					[ 'value' => 70, 'caption' => '20代', 'color' => '#0073B7'],
					[ 'value' => 30, 'caption' => '30代', 'color' => '#00AEEF'],
					[ 'value' => 110, 'caption' => '40代', 'color' => '#00B398'],
					[ 'value' => 110, 'caption' => '50代', 'color' => '#009F6B'],
					[ 'value' => 110, 'caption' => '60代', 'color' => '#008C4A'],
				]); ?>
			</svg>
		</div>
		<li>
			<div class="chart" >
				...
				<svg width="150" height="150" viewBox="0 0 200 200">
					<?php create_donut_graph(100, 100, 100, 40, [
						...
						[ 'value' => 5, 'caption' => '電車・バス', 'color' => '#D04255'],
					]); ?>
				</svg>
			</div>
		</li>
...
<section class="content" id="company_info">
	...
	<dl class="speclist">
		...
		<div>
			...
			<dd>
				<ul class="li_style">
					<li>一般調理食品製造（きのこ・山菜の味付加工・あんず及び果実類の加工・業務用食材加工・各種惣菜類の加工）</li>
				</ul>
			</dd>
		</div>
		<div>
		...
		<div>
			...
			<dd><?= $co['post-code']?><br><?= $co['adress']?><br>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6596.020125228804!2d138.17920567530763!3d36.44339911523458!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601d98e15a627d21%3A0xeda24e557340129a!2z5Lqk5ZKM54mp55SjKOagqik!5e0!3m2!1sja!2sjp!4v1742806913202!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</dd>
		</div>
		<div>
			<dt>本社電話番号</dt>
