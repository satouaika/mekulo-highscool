...
<section class="g" id="job_detail">
	<h2>仕事内容</h2>
	<p>
	    メカニックは、クルマの点検・整備・修理を行う仕事です。お客様と接する機会は少ないかもしれませんが、確かな点検整備をつうじて、お客様の安全を守る重要な役割を担っています。
	</p>
	<div class="images">
		<img src="contents01.jpg" alt="" class="scene">
	</div>
	<p>
		日常点検やオイル交換、タイヤ交換といった基本的な作業からスタートし、エンジンやブレーキなど重要なパーツの調整・修理を行います。
	</p>
	<div class="images">
	...
	<p>
		また、車検対応や診断機器を使ったトラブルシューティングなど、幅広い技術を身につけることができます。最初は先輩と一緒に作業を行いながら、実際のクルマを触りながら学ぶことができます。
	</p>
	<div class="images">
		<img src="contents04.jpg" alt="" class="scene">
	</div>
	<p>
		働きながら3級・2級整備士の資格を取得することも可能で、キャリアアップの道も開かれています。
	</p>
</section>
<!--
<section class="g">
