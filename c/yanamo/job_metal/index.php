...
<section class="g" id="job_detail">
	<h2>仕事内容</h2>
	<p>
		事故やキズでへこんだクルマを修理し、元の状態に戻す仕事です。軽いキズの修理から、大きなダメージを受けた車のフレーム修正まで、専用の機械を使いながら正確な作業を行います。
	</p>
	<div class="images">
		<img src="contents01.jpg" alt="" class="scene">
	</div>
	<p>
		板金作業では、車の形状を元に戻すために金属加工の技術を学びます。専用のツールを使って、へこんだ金属部分を引き出したり、押し戻したりします。
	</p>
	<div class="images">
		<img src="contents02.jpg" alt="" class="scene">
	</div>
	<p>
		小さなへこみや傷には、パテと呼ばれる充填材を使って修復します。パテを塗った後、表面を滑らかにするために研磨します。<br>
		研磨が不十分だと、塗装後に不自然な凹凸が残る可能性があるため、周囲と一体化して完全に平らになるまで、丁寧に磨いていきます。
	</p>
	<div class="images">
		<img src="contents03.jpg" alt="" class="scene">
	</div>
	<p>
		鈑金修理が終わると塗装をします。塗装作業で一番難しく、センスを求められるは何と言っても調色。各メーカーの指定の色を調合表どおりに配合しても、同じ色になることはほぼありません。車の色は時とともに変わっているからです。
	</p>
	<div class="images">
	...
	<div class="requirement">
		<div class="content recruitment">
			...
			<dl>
				...
				<div>
					<dt>その他休日</dt>
					<dd>土曜日休み月約平均2日、年末年始、GW、お盆休みあり</dd>
				</div>
			</dl>
			<h3>保険・年金・定年等</h3>
			<dl>
