...
<section class="g" id="job_detail">
	<h2>仕事内容</h2>
	<p>
		フロントスタッフは、お客様の受付や電話対応を行うだけでなく、整備スタッフと連携しながら業務を進める役割を担います。
	</p>
	<div class="images">
	...
	<p>
	    お客様が来店した際に、最初に対応します。車検や修理の目的を聞き取り、適切な担当者に引き継ぎます。柳沢モータースの顔として働くポジションです。
	</p>
	<div class="images">
		<img src="contents03.jpg" alt="" class="scene">
	</div>
	<p>
		お客様が困っていることを聞き出し、適切なサービスを提案することも大切な仕事です。お客様から聞いた車の状態や要望を整備士に伝え、お客様と工場をつなぎます。
	</p>
	<div class="images">
		<img src="contents05.jpg" alt="" class="scene">
	</div>
	<p>
		車検や点検の案内、見積もりの作成、請求書の発行など、事務作業も多くあります。修理や整備に必要な部品を注文し手配もします。
	</p>
	<div class="images">
		<img src="contents06.jpg" alt="" class="scene">
	</div>
	<p>
		車検や定期点検の時期が近づいたお客様に連絡し、案内を行うことも大切な仕事です。
	</p>
</section>
<!--
<section class="g">
