...
<div class="content_area">
    ...
    <?php endif; ?>
		...
		<section class="g" id="job_detail">
			...
			<p>
				私たちの仕事は、約800度に溶かしたアルミを「金型」と呼ばれる製品の型に流し込み、固めることで自動車や自転車などに使われる部品を製造することです。
			</p>
			<div class="images">
			...
			<p>
				流し込んだ後は、製品が固まるまで待機する時間があるため、一人で複数の金型を担当します。5kgの製品は約3分、1kgの製品は1キロだったら約1分で固まります。<br>
