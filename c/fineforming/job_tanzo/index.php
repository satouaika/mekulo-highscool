    ...
    <?php endif; ?>
		...
		<section class="g" id="job_detail">
			...
			<p>
				...
				その一つに、「力加減」があります。<br>
				見た目はアルミ色ですが、実際には700℃程の高温で部品が流れてきます。<br>
				そのため、ハサミを使ってアルミ鋳造部品を持ち上げるのですが、強くつかみすぎると跡がついてしまい、不良品になってしまいます。職人の感覚が試される場面です。
			</p>
			<div class="images">
			...
			<p>
				...
				最後に「左右の手の連携」です。<br>
				左手ではハサミを使って、熱したアルミ鋳造部品を持ち、右手で離型剤を吹きかける。そして左手で金型の正しい位置に部品を設置し、両手を使ってプレスをする。
			</p>
			<div class="images">
