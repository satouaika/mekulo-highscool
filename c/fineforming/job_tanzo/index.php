			...
			<div class="requirement">
				<div class="content recruitment">
					...
					<dl>
						...
						<div>
							<dt>休日・休暇</dt>
							<dd>週休2日制、年間休日115日（2025年度計画）</dd>
						</div>
						<div>
							<dt>適用保険</dt>
							<dd>厚生年金、健康保険、雇用保険、労災保険、財形</dd>
						</div>
						<div>
							<dt>時間外勤務の状況</dt>
							<dd>月平均19時間位</dd>
				...
				<div class="content">
					...
					<dl>
						<div>
							<dt>研修制度</dt>
							<dd>あり。<br>入社後、まずは安全教育を実施します。製造部長が講師となり、工場内での安全管理や作業の基本ルールを学びます。また、社長から給与明細の見方や社会保険料についての説明があり、働く上で必要な知識を身につけます。これらの研修を通じて、安心して仕事に取り組める環境を整えます。</dd>
						</div>
						<div>
							<dt>自己啓発支援制度</dt>
							<dd>なし</dd>
						...
						<div>
							<dt>社内検定等の制度</dt>
							<dd>あり。<br>フォークリフト、クレーン、玉掛けなど、業務に必要な資格の取得を会社が支援します。また、品質管理検定については会社負担で受験でき、合格するとお祝い金を支給する制度があります。スキルアップを目指す社員を積極的にサポートします。</dd>
						</div>
					</dl>
				</div>
