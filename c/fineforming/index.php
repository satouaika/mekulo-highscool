...
<div class="about-com content" id="company_gallery">
	...
	<p>
		「鋳造」とは、アルミを溶かして型に流し込み、部品を作る技法です。<br>
		「鋳造」とは、熱したアルミ部品を1,000tの圧力で叩いて、金属の強度を高める技法です。<br>
...
<div class="job_btn">
	...
	<p>
		2025年3月現在、ファイミンフォーミングでは20代・30代が中心の会社です。<br>
		離職率も〇%と低く、長く働きやすい環境です。<br>
		また、ファイミンフォーミングでは、<strong>チームで仕事を進めるので、すぐに職場に馴染める</strong>のもポイント！<br>
		初めは緊張していた人も、気がつけば<strong>和気あいあいと会話が弾む職場</strong>です。
	</p>
</div>
<section class="content" id="about_company">
	<h2>会社情報記事</h2>
	<h3>
		キミはどっち派？<ruby>鋳造<rt>ちゅうぞう</rt></ruby>と<ruby>鍛造<rt>たんぞう</rt></ruby>、それぞれの仕事スタイル！
	</h3>
	<p>
	...
	<p>
		例えば、アルミを型に流し込むときに、勢いよく入れると空気を巻き込み、不良品になってしまう。一方で、ゆっくりすぎると温度が下がってしまい、キレイに固まりません。<br>
...
<section class="content" id="from_president">
	...
	<div class="pre_con">
		...
		<p>
			サンプルテキストサンプルテキストサンプルサンプルテキストサンプルテキストサンプルサンプルテキストサンプルテキストサンプルサンプルテキストサンプルテキストサンプルサンプル
		</p>
	</div>
</section>
