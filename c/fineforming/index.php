...
<h2>会社からのメッセージ</h2>
	<div class="pre_con">
		<h3>鍛造・鋳造の迫力、見に来てみませんか？</h3>
		<figure class="portrait">
			<img src="message.jpg" alt="">
			<figcaption><span class="word">笹邉紀三子</span></figcaption>
		</figure>
		<p>
			私たちファイミンフォーミングは、創業以来、長野県上田市の真田町で、アルミという軽くて強い金属を使って、自動車や自転車などの部品を作っている会社です。<br>
            特に自慢なのが、「鋳造（ちゅうぞう）」と「鍛造（たんぞう）」という2つの技術を組み合わせた“アルミ鋳造鍛造法”。実は、これをやっているのは日本でウチだけなんです！<br>
            でも、そんなすごい技術を使っていても、仕事をするのは人。<br>
			つまり、<b>あなたのような若い力が、これからのモノづくりを支えていく主役</b>になります。
		</p><br>
		<p>
			鋳造は、繊細さと集中力が求められる“じっくり型”の仕事。<br>
            鍛造は、リズム感とチームワークが大事な“スピード型”の仕事。<br>
            どちらも、やってみないと分からない面白さがあります。<br>
            うちの会社は、20代・30代が中心で、みんなで声を掛け合いながら仕事をしています。最初は分からなくて当たり前。誰だって未経験からスタートします。<br>
            だけど、ものづくりの現場には、「やった分だけ成長できる」「自分の手でカタチを生み出せる」というワクワクがあります。<br>
            興味がわいたら、まずは見学に来てください。大きな機械や熱くて真剣な現場、きっと驚くと思いますよ。そして、「カッコいいな」と思ったら、ぜひ一緒に働きましょう！
		</p>
	</div>
</section>
