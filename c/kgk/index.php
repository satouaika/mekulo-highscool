...
<section class="content" id="from_president">
	...
	<div class="pre_con">
		<figure class="portrait">
			...
			<figcaption><span class="name">黒岩部長</span></figcaption>
		</figure>
		<p>
			科学技術開発センターには、自然が好きな“アウトドア派”の社員がたくさんいます。休みの日には山に入り、ソロキャンプをしたり、野草や昆虫を観察したり。そんな日常の中で育まれた好奇心は、実は仕事でもとても役立っています。たとえば、ある現場で測定中にちょっとした違和感に気づき、そこから新たな検査が必要だと判断されたことも。大切なのは、「お客様の会社の安全を守るために、自分たちは何が提供できるだろう？」という視点です。科学や自然が好きなあなた、その“気づく力”を社会の役に立ててみませんか？あなたの好奇心が、未来を守る力になります。
		</p>
	</div>
</section>
