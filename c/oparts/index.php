...
<section class="content" id="about_company">
	...
	<div class="images">
		...
		<img src="company2.jpg" class="scene" alt="">
	</div>
	<p>
...
<section class="content" id="numeric_data">
	...
	<ul class="fl_con">
		...
		<div class="chart">
			...
			<svg width="150" height="150" viewBox="0 0 200 200">
				<?php create_donut_graph(100, 100, 100, 40, [
					[ 'value' => 40, 'caption' => '20代', 'color' => '#0073B7'],
					[ 'value' => 30, 'caption' => '30代', 'color' => '#00AEEF'],
					[ 'value' => 70, 'caption' => '40代', 'color' => '#00B398'],
...
<section class="content" id="company_info">
	...
	<dl class="speclist">
		...
		<div>
			<dt>従業員数</dt>
			<dd>17名（役員、パート・アルバイト含む）（2025年1月1日現在）</dd>
		</div>
		<div>
			<dt>本社所在地</dt>
			<dd><?= $co['post-code']?><br><?= $co['adress']?><br>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122216.89758049759!2d138.24796008607984!3d36.47843434020319!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601dbe14c5a3ccc1%3A0xbba8de7ea553eecb!2z5qCq5byP5Lya56S-IOWJtemiqA!5e0!3m2!1sja!2sjp!4v1742129589116!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</dd>
		</div>
		<div>
			<dt>本社電話番号</dt>
...
<section class="content" id="from_president">
	...
	<div class="pre_con">
		...
		<figure class="portrait">
			...
			<figcaption><span class="word">金子慎也</span></figcaption>
		</figure>
		<p>
			私たちが求めているのは、勉強が得意な人ではなく、想像力のある人です。サイコロの展開図を思い浮かべるのが得意な人や、パズルゲームが好きな人は、この仕事に向いていると思います。
		</p>
		<p>
			創風の仕事では、指示を待つのではなく「次に何をすればいいか」を自分で考えることが大切です。最初は教わることが多いですが、周りを見て動ける人、リーダーシップを持って先頭に立てる人が活躍できます。<br>
...
<section class="content" id="job_list">
	...
	<ul class="image_navi">
		<li>
			<a href="<?= $company_base ?>job_dakutoman/">
				<figure>
					<img src="job-fv.jpg" alt="">
